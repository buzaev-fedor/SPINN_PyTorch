...
run_algorithm() {
    ...
    python demo_bbo_optimization_klein_gordon3d.py \
        --algorithm "$algorithm" \
        --nc 1000 \
        --ni 100 \
        --nb 100 \
        ...
        --epochs 10000 \
        --n-trials 150 \
        --population-size 32 2>&1 | tee -a "$LOG_FILE"
...
# Main execution
log_message "Starting optimization process for all algorithms"

# List of algorithms to run
ALGORITHMS=("jade" "lshade")
